                  ...
                  <div key={m.id} className="flex gap-2">
                    ...
                    <div className="bg-white rounded-2xl rounded-tl-none p-3.5 max-w-[88%] shadow-xs border border-teal-200/90 space-y-3">
                      <div className="flex items-center gap-2 text-teal-900">
                        <div className="p-1.5 bg-teal-50 rounded-xl text-teal-700">
                          <ClipboardList className="w-5 h-5" />
                        </div>
                        <div>
                          <div className="text-xs font-black text-slate-900 flex items-center gap-1.5">
                            <span>綠色家庭醫學推動計畫</span>
                          </div>
                          <div className="text-[10px] text-teal-600 font-bold">
                            台灣家庭醫學醫學會 ╳ WaCare 共同推動
                          </div>
                        </div>
                      </div>

                      <p className="text-[11px] text-slate-600 leading-relaxed">
                        請點擊下方專屬活動超連結，前往綠色處方活動頁完成「步驟一：同意書簽署」與「步驟二：生活型態問卷填寫」，完成後診所將為您調配專屬處方！
                      </p>

                      {/* Clickable Hyperlink & Link Preview Box */}
                      <div className="pt-2 border-t border-slate-100 space-y-2">
                        <div className="text-[11px] text-slate-500 font-medium">
                          🔗 活動專屬超連結：
                        </div>

                        {/* Hyperlink anchor container */}
                        <div
                          onClick={() => onNavigate('GREEN-PRESCRIPTION-EVENT')}
                          className="bg-sky-50/80 hover:bg-sky-100/90 active:scale-98 border border-sky-200 rounded-xl p-2.5 flex items-center justify-between cursor-pointer transition-all group"
                        >
                          <div className="min-w-0 pr-2">
                            <div className="text-xs font-black text-sky-800 group-hover:text-sky-900 truncate">
                              🌿 綠色處方活動專屬頁
                            </div>
                            <div className="text-[10px] text-sky-600 underline underline-offset-2 break-all group-hover:text-sky-700 font-medium">
                              https://wacare.app/green-rx/event
                            </div>
                          </div>
                          <div className="w-6 h-6 rounded-full bg-sky-600 text-white flex items-center justify-center shrink-0 group-hover:translate-x-0.5 transition-transform shadow-xs">
