...
export const QuestionnaireResultScreen: React.FC<Props> = ({
  ...
  const displayGoals = submittedGoals;
      ...
      <div className="flex-1 overflow-y-auto bg-slate-50/50 pb-10">
        ...
        <div className="bg-white pt-6 pb-5 px-6 text-center border-b border-slate-100 space-y-3">
          <div className="space-y-0.5">
            <div className="text-2xl font-black text-emerald-500 tracking-tight flex items-center justify-center gap-2">
          ...
          <div className="p-5 space-y-3">
            ...
            <div className="space-y-2.5 pt-1">
              {displayGoals.length === 0 ? (
                <p className="rounded-xl border border-slate-200 bg-slate-50 p-4 text-sm font-bold text-slate-500">此筆紀錄沒有可顯示的填寫內容。</p>
