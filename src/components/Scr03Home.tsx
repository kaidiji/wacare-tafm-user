  ...
  return (
    <div className="h-full bg-slate-100 flex flex-col justify-between overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto min-h-0 touch-pan-y pb-24 space-y-5">
        ...
        {/* Section 2: 我的報名（目前僅供畫面展示） */}
        <div className="px-4">
          <button
            type="button"
            disabled
            className="w-full bg-white rounded-2xl p-3.5 border border-slate-100 shadow-xs flex items-center justify-between cursor-default"
          >
            <div className="flex items-center gap-2">
              <span className="w-2 h-2 rounded-full bg-orange-500" />
              <span className="text-sm font-black text-slate-900">我的報名</span>
            </div>
